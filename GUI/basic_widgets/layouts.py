...
class TabButton(Button):
    def __init__(self, tab: '_MutiDirectionTab', image: QImage, tool_tip, bd_radius=7):
        ...
        self._temp_button = Button(None, None, 0, BG_COLOR1, bd_radius,
                                   bg=(GRAY, BG_COLOR3, GRAY, BG_COLOR3), size=25, alpha=0.6)
...
class FreeTabFrame(QFrame):
    ...
    def __init__(self, direction, bt_widget, bt_direction: Literal['left', 'right', 'up', 'down'], multi_direction_tab=None):
        ...
        self.bt_widget_layout.setContentsMargins(0, 4, 0, 4)
        self.bt_widget_layout.setSpacing(4)
        # 临时控件，用于拖动时显示
    ...
    def _init_temp_widget(self):
        self._temp_button_frame.setFixedSize(25, 25)
...
class MultiDirTabMainFrame(QFrame):
    ...
    def init_ui(self):
        ...
        self.left_up_bt_frame.setFixedWidth(32)
        self.left_down_bt_frame.setFixedWidth(32)
        self.right_bt_frame.setFixedWidth(32)
        self.layout.setSpacing(0)
...
class Window(QWidget):
    def __init__(
            self, parent, title: str, ico_bites: bytes, ico_size: int = 18, topH: int = 30, bottomH: int = 30,
            ...
            bd_radius: Union[int, Tuple[int, int, int, int]] = 4,
            ask_if_close=True
    ):
        """
