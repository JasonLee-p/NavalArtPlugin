...
from PyQt5.QtWidgets import QApplication, QFileDialog, QShortcut, QToolButton, QMenu, QCheckBox, QSlider
...
from .dialogs import NewProjectDialog, ThemeDialog, SensitiveDialog, ColorDialog
# 函数
...
__all__ = [
    ...
    "QApplication", "QFileDialog", "QShortcut", "QToolButton", "QMenu", "QCheckBox", "QSlider",
    ...
    "NewProjectDialog", "ThemeDialog", "SensitiveDialog", "ColorDialog",
    # 函数
